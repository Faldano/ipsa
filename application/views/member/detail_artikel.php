...
<body>
  <header class="w-section header">
    <div class="w-nav navbar" data-animation="over-left" data-collapse="all" data-doc-height="1" data-duration="500" data-no-scroll="1">
      ...
      <a class="w-nav-brand brand" href=<?php echo site_url('publik/home');?>>
      ...
      <nav class="w-nav-menu nav-menu" role="navigation">
        ...
        <a class="w-nav-link main-link" href="#">news</a>
        <a class="w-nav-link main-link" href="#">Publications</a>
        <a class="w-nav-link main-link" href="#">Events</a>
