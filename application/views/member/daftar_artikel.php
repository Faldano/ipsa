      ...
      <nav class="w-nav-menu nav-menu" role="navigation">
        ...
        <div class="w-dropdown" data-delay="0">
          ...
          <nav class="w-dropdown-list drop-list">
            <a class="w-dropdown-link main-link" href="<?php echo site_url('publik/home');?>">- aspi overview</a>
            <a class="w-dropdown-link main-link" href="<?php echo site_url('publik/home');?>">-&nbsp;Vision and Mission</a>
            <a class="w-dropdown-link main-link" href="<?php echo site_url('publik/home');?>">-&nbsp;Structure</a>
          </nav>
        </div>
        <a class="w-nav-link main-link" href="<?php echo site_url('publik/index_artikel');?>">Publications</a>
        <a class="w-nav-link main-link" href="<?php echo site_url('publik/index_event');?>">Events</a>
      </nav>
      <a class="w-inline-block login-button"  href="<?php echo site_url('publik/logout');?>">
  ...
  <section class="w-section section news">
    ...
    background-size: 350px;background-image:url( <?php echo base_url('upload/'.$artikel->image);?>" ></div>
            ...
            <article class="third-block-content-single bottom-margin-medium half">
              ...
              <h4 class="bottom-margin-small"><?php echo $artikel->title;?></h4>
              <a class="small-text" data-ix="call-to-action-more" href="<?php echo site_url('publik/select_artikel/'.$artikel->id_artikel);?>"><span>SELENGKAPNYA</span> <span class="more-arrow">→</span></a>
            </article>
          </article  >    
        </div >
        <?php }?>
