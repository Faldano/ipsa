...
<body>
  <header class="header w-section">
    <div class="navbar w-nav" data-animation="over-left" data-collapse="all" data-doc-height="1" data-duration="500" data-no-scroll="1">
      ...
      <a class="brand w-nav-brand" href="<?php echo site_url('publik/home');?>">
        <h1 class="brand-text">Asosiasi Sel Punca Indonesia</h1>
      </a>
      <nav class="nav-menu w-nav-menu" role="navigation">
        <a class="main-link w-nav-link" href="<?php echo site_url('publik/select_all_artikel');?>">news</a>
        <a class="main-link w-nav-link" href="<?php echo site_url('publik/index_event');?>">Events</a>
        <a class="main-link w-nav-link" href="<?php echo site_url('publik/select_all_jurnalis');?>">Publication</a>
      </nav>
      <a class="login-button w-inline-block" href="<?php echo site_url('publik/Logout');?>">
        ...
        <div class="w-row">
          <div class="align-left logo w-clearfix w-col w-col-6">
            <a class="footer-brand w-inline-block" href="#">
              <img src="../images/aspi white.png" width="200">
            </a>
