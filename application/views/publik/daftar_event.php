  ...
  <header class="header w-section">
    <div class="navbar w-nav" data-animation="over-left" data-collapse="all" data-doc-height="1" data-duration="500" data-no-scroll="1">
      ...
      <nav class="nav-menu w-nav-menu" role="navigation">
        ...
        <a class="main-link w-nav-link" href="<?php echo site_url('member/home');?>">news</a>
          ...
          <div class="block-main-row w-row">
            <div class="col w-col w-col-6">
              <article class="block-main-holder left">
                ...
                <a class="bottom-margin-small small-text" data-ix="call-to-action-more" href="<?php echo site_url('member/event_single/'.$event->id_event);?>">SELENGKAPNYA&nbsp;<span class="more-arrow">→</span></a>
              </article>
            </div>
        ...
        <div class="w-row">
          <div class="align-left logo w-clearfix w-col w-col-6">
            ...
            <div class="footer-menu">
              ...
              <a class="footer-link" href="<?php echo site_url('member/home');?>">News</a>
