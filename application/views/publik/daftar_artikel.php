...
<body>
  ...
  <section class="about section-hero title w-section">
    <div class="about-header container w-container">
      <h1 class="bottom-margin-extra-small" data-ix="fly-in-load-side">News</h1>
      <h3 class="hero-sub-title" data-ix="fly-in-load-2">Keep up to date with our latest ideas and reports</h3>
    </div>
  </section>
    ...
    <div class="container w-container" data-ix="fly-in-load-3">
      <div class="row w-row">
        ...
        <div class="col w-col w-col-4 w-col-stack">
          <div class="news-item" data-ix="fly-on-scroll">
            <article class="third-block-holder-single">
              <div class="image-1 image-holder" style="background-repeat:no-repeat; ackground-position: 50% 50%;
                          background-size:cover;background-image:url(<?php echo base_url('upload/'.$artikel->image);?>)"></div>
              <article class="bottom-margin-medium half third-block-content-single">
                <div class="date"><?php echo $artikel->tgl;?></div>
                <h4 class="bottom-margin-small"><?php echo substr($artikel->title,0,22);?></h4>
                <a class="small-text" data-ix="call-to-action-more" href="<?php echo site_url('member/news_single/'.$artikel->id_artikel);?>"><span>SELENGKAPNYA</span> <span class="more-arrow">→</span></a>
              </article>
            </article>
          </div>
        </div>
