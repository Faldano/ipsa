...
<body>
  <header class="w-section header">
    <div class="w-nav navbar" data-animation="over-left" data-collapse="all" data-doc-height="1" data-duration="500" data-no-scroll="1">
      ...
      <a class="w-nav-brand brand" href="<?php echo base_url('index.php/guest/home');?>">
        <h1 class="brand-text">Asosiasi Sel Punca Indonesia</h1>
      </a>
      <nav class="w-nav-menu nav-menu" role="navigation">
        <a class="w-nav-link main-link" href="<?php echo base_url('index.php/guest/home');?>">HOME</a>
        ...
        <a class="w-nav-link main-link" href="<?php echo site_url('guest/select_all_artikel');?>">News</a>
        <a class="w-nav-link main-link" href="<?php echo site_url('guest/select_all_jurnal');?>">Publications</a>
        <a class="w-nav-link main-link" href="<?php echo site_url('guest/index_event');?>">Events</a>
  ...
  <section class="w-section section-hero title about">
    <div class="w-container container about-header">
      <h1 class="bottom-margin-small"><?php echo $daftar_artikel->title;?></h1>
      <h3 class="hero-sub-title"><?php echo substr($daftar_artikel->tgl,0,10);?></h3>
    </div>
  </section>
  <section class="w-section section---white-holder">
    <div class="w-container container">
      <p class="bottom-margin-medium paragraph-justified">Duis mollis, est non commodo luctus, nisi erat porttitor </p>
      <img class="selected-news-img" src="<?php echo base_url('./upload/'.$daftar_artikel->image);?>">
      <p class="bottom-margin-medium paragraph-justified"><?php echo $daftar_artikel->information;?>
        <br>
        <br>Nulla vitae elit libero, a pharetra augue. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo. Vestibulum id ligula porta felis euismod semper. Donec id elit non mi porta gravida at eget metus.</p>
    </div>
  </section>
  <section class="w-section section news">
    <div class="w-container container">
      <h2 class="bottom-margin-medium">Recent News</h2>
      <div class="w-row row">
