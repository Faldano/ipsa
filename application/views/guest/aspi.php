...
<body>
  ...
  <section class="section w-section">
    <div class="w-container" data-ix="fly-on-scroll">
      ...
      <div>
        <a class="button w-button" href="<?php echo site_url('about');?>">Selengkapnya</a>
      ...
      <div class="block-main-row w-row">
        <div class="col w-col w-col-6 w-col-stack">
          <article class="block-main-holder left">
            <h2 class="bottom-margin-medium" data-ix="fly-on-scroll-side"><a class="pagelink" href="<?php echo site_url('news');?>">Recent News</a></h2>
            ...
            <?php foreach($daftar_artikel as $artikel){?>
              <div class="recent-news-item" data-ix="fly-on-scroll">
                <a class="news-block w-clearfix w-inline-block" data-ix="call-to-action-more" href="<?php echo site_url('news_single/'.$artikel->id_artikel);?>">
        ...
        <div class="col w-col w-col-6 w-col-stack">
          <article class="block-main-holder">
            <h2 class="bottom-margin-medium" data-ix="fly-on-scroll-side"><a class="pagelink" href="<?php echo site_url('publications');?>">Publication Updates</a></h2>
            <div class="border" data-ix="fly-on-scroll-side"></div>
            
            <?php foreach($daftar_jurnalis as $jurnal_publik){?> 
              <div data-ix="fly-on-scroll">
                <a class="news-block publication-block w-inline-block" data-ix="call-to-action-more" href="<?php echo site_url('publication_single/'.$jurnal_publik->id_jurnalpublik);?>">
                  <div class="publication-title"><?php echo $jurnal_publik->judul;?></div>
                  <div class="more">Selengkapnya <span class="more-arrow">»</span>
                  </div>
                </a>
              </div>
  ...
  <section class="event-section section w-section">
    <h2 class="bottom-margin-medium" data-ix="fly-on-scroll-side"><a class="pagelink" href="<?php echo site_url('events');?>">Events</a></h2>
    <div class="border" data-ix="fly-on-scroll-side"></div>
    <div class="row w-row">
      ...
      <div class="nopad-col w-col w-col-3 w-col-medium-6">
        <div data-ix="fly-on-scroll">
          <a class="event-link w-inline-block" data-ix="call-to-action-event" href="<?php echo site_url('event_single/'.$event->id_event);?>">
