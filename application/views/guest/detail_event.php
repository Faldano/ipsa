  ...
  <div class="full-width-holder">
    <header class="header w-section">
      <div class="navbar w-nav" data-animation="over-left" data-collapse="all" data-doc-height="1" data-duration="500" data-no-scroll="1">
        ...
        <a class="brand w-nav-brand" href="<?php echo base_url('index.php/guest/home');?>">
        ...
        <nav class="nav-menu w-nav-menu" role="navigation">
          <a class="main-link w-nav-link" href="<?php echo base_url('index.php/guest/home');?>">HOME</a>
          <div class="w-dropdown" data-delay="0">
            ...
            <nav class="drop-list w-dropdown-list">
              <a class="main-link w-dropdown-link" href="/about?tab=tab1">- aspi overview</a>
              <a class="main-link w-dropdown-link" href="/about?tab=tab2">-&nbsp;Vision and Mission</a>
              <a class="main-link w-dropdown-link" href="/about?tab=tab3">-&nbsp;Structure</a>
            </nav>
          </div>
          <a class="main-link w-nav-link" href="<?php echo site_url('guest/select_all_artikel');?>">News</a>
          <a class="main-link w-nav-link" href="<?php echo site_url('guest/select_all_jurnal');?>">Publications</a>
          <a class="main-link w-nav-link" href="<?php echo site_url('guest/index_event');?>">Events</a>
          <a class="main-link w-nav-link" href="contact.html">CONTACT Us</a>
        </nav>
    ...
    <section class="full-width section-hero w-section">
      <div class="hero-align-bottom">
        <div class="container w-container">
          <div class="work-title-holder">
            <h1 class="work-single-title">Event Title</h1>
    ...
    <div class="container content w-container" data-ix="fly-on-scroll">
      <div class="w-row">
        <div class="col padding w-col w-col-6">
          <p class="paragraph-justified">Maecenas sed diam eget risus varius blandit sit amet non magna. Curabitur blandit tempus porttitor. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.</p>
        </div>
        <div class="col padding w-col w-col-6">
          <div class="black-font bottom-margin-small event-date-time">Date &amp; Time</div>
          <div class="black-font event-place">Place</div>
        </div>
      </div>
    </div>
  </section>
  <a class="call-to-action w-inline-block" data-ix="call-to-action" href="contact.html">
        ...
        <div class="w-row">
          <div class="align-left logo w-clearfix w-col w-col-6">
            ...
            <div class="footer-menu">
              <a class="footer-link" href="<?php echo base_url('index.php/guest/home');?>">Home</a>
              <a class="footer-link" href="<?php echo site_url('guest/about');?>">About Us</a>
              <a class="footer-link" href="<?php echo site_url('guest/select_all_artikel');?>">News</a>
              <a class="footer-link" href="<?php echo site_url('guest/select_all_jurnal');?>">Publications</a>
              <a class="footer-link" href="<?php echo site_url('guest/index_event');?>">Events</a>
              <a class="footer-link" href="<?php echo site_url('guest/contact');?>">Contact Us</a>
            </div>
          </div>
