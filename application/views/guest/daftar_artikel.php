  ...
  <section class="news section w-section">
    ...
    background-size: 350px;background-image:url(<?php echo base_url('upload/'.$artikel->image);?>)" ></div>
              <article class="bottom-margin-medium half third-block-content-single">
                ...
                <a class="small-text" data-ix="call-to-action-more" href="<?php echo site_url('news_single/'.$artikel->id_artikel);?>"><span>SELENGKAPNYA</span> <span class="more-arrow">→</span></a>
              </article>
            </article>
          </div>
        </div>
