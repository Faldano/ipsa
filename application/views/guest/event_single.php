          ...
          <div class="popup-bracket">
            ...
            <div class="w-form">
              ...
              <?php echo form_open('member/login')?>
                ...
                <input class="field w-input"  maxlength="40" name="username" placeholder="Enter username" required="required" type="text">
  ...
  <div class="full-width-holder">
    <header class="header w-section">
      <div class="navbar w-nav" data-animation="over-left" data-collapse="all" data-doc-height="1" data-duration="500" data-no-scroll="1">
        ...
        <a class="brand w-nav-brand" href="<?php echo site_url('guest');?>">
        ...
        <nav class="nav-menu w-nav-menu" role="navigation">
          <a class="main-link w-nav-link" href="<?php echo site_url('guest');?>">HOME</a>
