 ...
 <header class="w-section header">
  ...
  <section class="news section w-section">
    <div class="container w-container">
      <div class="w-form">
        <?php echo form_open_multipart('login_by_navatari/proses_edit_event');?>
          <div class="w-clearfix">
            <label class="admin-label" for="News-Title">Event's Name:</label>
            <textarea class="admin-field w-input"  name="judul" type="text"><?php echo $event->judul;?></textarea>
            
            <label class="admin-label" for="News-Content">Description:</label>
            <textarea class="admin-text-field w-input"  name="deskripsi"><?php echo $event->deskripsi;?></textarea>
            
            <label class="admin-label" for="News-Title">Place:</label>
            <textarea class="admin-field w-input"  name="tempat" type="text"><?php echo $event->tempat;?></textarea>

            <label class="admin-label" for="News-Title">Date: <?php echo $event->tgl;?></label>
            <input class="admin-field w-input"  name="tgl" type="date">

            <label class="admin-label" for="News-Title">Time: <?php echo $event->waktu;?></label>
            <input class="admin-field w-input"  name="waktu"  type="time">

            <label class="admin-label" for="email-2"></label>
