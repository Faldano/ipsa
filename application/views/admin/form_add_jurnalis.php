...
<body>
  ...
  <section class="news section w-section">
    <div class="container w-container">
      <div class="w-form">
        <?php echo form_open('login_by_navatari/proses_add_jurnalis')?>
          <div class="w-clearfix">
            <label class="admin-label" for="Publication-Title-2">Title:</label>
            <input class="admin-field w-input" maxlength="256" name="judul" placeholder="Enter Publication Title" required="required" type="text">
            <label class="admin-label" for="Publication-Content">Publication Content:</label>
            <textarea class="admin-text-field w-input" maxlength="5000" name="deskripsi" placeholder="Enter Text Content" required="required"></textarea>
            <label class="admin-label" for="Publication-Link">Link:</label>
            <input class="admin-field w-input"  name="link" placeholder="Enter the Link" required="required" type="text">
          </div>
