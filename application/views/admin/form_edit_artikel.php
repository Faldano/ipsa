...
<body>
  ...
  <section class="news section w-section">
    <div class="container w-container">
      <div class="w-form">
        <?php echo form_open_multipart('login_by_navatari/proses_edit_artikel');?>
          <div class="w-clearfix">
            <label class="admin-label" for="News-Title">News Title:</label>
            <textarea class="admin-field w-input"  name="title" type="text"><?php echo $artikel->title;?></textarea>
            <label class="admin-label" for="News-Content">News Content:</label>
            <textarea class="admin-text-field w-input"  name="information" type="text"><?php echo $artikel->information;?></textarea>
