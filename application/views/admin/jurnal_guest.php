...
<head>
  <meta charset="utf-8">
  <title>Admin - Publication Guest</title>
...
<body>
  ...
  <section class="about admin-header section-hero title w-section">
    <div class="admin-container container w-container">
      <h1 class="bottom-margin-extra-small">Publication Guest</h1>
      <div class="hero-sub-title">Edit or delete publication content.</div>
    </div>
  </section>
      ...
      <div class="publication-item">
        <article class="bottom-margin-medium third-block-holder-single">
          <article class="bottom-margin-medium half third-block-content-single">
            ...
            <a class="small-text" data-ix="call-to-action-more" href="<?php echo site_url('login_by_navatari/publication_guest_single/'.$jurnal_publik->id_jurnalpublik);?>"><span>SELENGKAPNYA</span> <span class="more-arrow">→</span></a>
            <div class="admin-block">
              <a class="edit-button w-button" href="<?php echo site_url('login_by_navatari/edit_jurnal/'.$jurnal_publik->id_jurnalpublik);?>">Edit</a>
              <a class="delete edit-button w-button" href="<?php echo site_url('login_by_navatari/delete_jurnal_guest/'.$jurnal_publik->id_jurnalpublik);?>">Delete</a>
            </div>
          </article>
        </article>
      </div>
