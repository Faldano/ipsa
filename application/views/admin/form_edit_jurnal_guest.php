 ...
 <header class="w-section header">
  ...
  <section class="news section w-section">
    <div class="container w-container">
      <div class="w-form">
        <?php echo form_open('login_by_navatari/proses_edit_jurnal')?>
          <div class="w-clearfix">
            <label class="admin-label" for="Publication-Title-2">Title:</label>
            <textarea class="admin-field w-input" maxlength="256" name="judul" type="text"><?php echo $jurnal_publik->judul;?></textarea>
            <label class="admin-label" for="Publication-Content">Publication Content:</label>
            <textarea class="admin-text-field w-input" maxlength="5000" name="deskripsi" type="text" ><?php echo $jurnal_publik->deskripsi;?></textarea>
            <label class="admin-label" for="Publication-Link">Link: </label>
            <textarea class="admin-field w-input"  name="link" type="text"> <?php echo $jurnal_publik->link;?> </textarea>
            <input type="hidden" name="id_jurnalpublik" value="<?php echo $jurnal_publik->id_jurnalpublik;?>"
          </div>
          <div class="but-contain w-clearfix">
            <a class="cancel purple-button w-button" href="<?php echo site_url('login_by_navatari/publications_guest');?>">Cancel</a>
