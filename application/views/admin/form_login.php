...
<head>
  ...
  <link rel="apple-touch-icon" href="<?php echo base_url('aset/images/Waruga Mahkota 256x256.png');?>">
...
<body>
  ...
  <section class="about admin-header section-hero title w-section">
    <div class="admin-container container w-container">
      <h1 class="bottom-margin-extra-small">Admin Login</h1>
