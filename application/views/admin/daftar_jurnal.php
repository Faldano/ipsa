...
<html data-wf-site="57700e53b57b99db3abdccde" data-wf-page="5771363b5cef0da03a79fdb2">
<head>
  <meta charset="utf-8">
  <title>Admin - Publication</title>
  <meta property="og:title" content="Admin - Publication">
...
<body>
  ...
  <section class="about admin-header section-hero title w-section">
    <div class="admin-container container w-container">
      ...
      <div class="hero-sub-title">Add, edit, or delete publication content.</div>
    </div>
  </section>
  <section class="news section w-section">

<a class="add-button w-button" href="<?php echo site_url('login_by_navatari/add_jurnalis');?>">Add Publication</a>
     <!-- declare here -->
      ...
      <div class="publication-item">
        <article class="bottom-margin-medium third-block-holder-single">
          <article class="bottom-margin-medium half third-block-content-single">
            ...
            <a class="small-text" data-ix="call-to-action-more" href="<?php echo site_url('login_by_navatari/publication_single/'.$jurnalis->id_jurnalis);?>"><span>SELENGKAPNYA</span> <span class="more-arrow">→</span></a>
            <div class="admin-block">
              <a class="edit-button w-button" href="<?php echo site_url('login_by_navatari/edit_jurnalis/'.$jurnalis->id_jurnalis);?>">Edit</a>
              <a class="delete edit-button w-button" href="<?php echo site_url('login_by_navatari/delete_jurnalis/'.$jurnalis->id_jurnalis);?>">Delete</a>
            </div>
            <a class="public purple-button w-button" href="<?php echo site_url('login_by_navatari/add_to_publik/'.$jurnalis->id_jurnalis);?>">Make it Public!</a>
          </article>
        </article>
      </div>
      <?php } ?> 
        ...
        <div class="w-row">
          <div class="align-left logo w-clearfix w-col w-col-6">
            ...
            <div class="footer-menu">
              <!--<a class="footer-link" href="<?php //echo site_url('login_by_navatari/view_success_page');?>">Member Applicants</a>
              ...
              <a class="footer-link" href="<?php //cho site_url('login_by_navatari/index_member');?>">Memberships</a>-->
            </div>
          </div>
