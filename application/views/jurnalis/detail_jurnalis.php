...
<body>
  <header class="w-section header">
    <div class="w-nav navbar" data-animation="over-left" data-collapse="all" data-doc-height="1" data-duration="500" data-no-scroll="1">
      ...
      <nav class="w-nav-menu nav-menu" role="navigation">
        <a class="w-nav-link main-link" href="index.html">HOME</a>
        ...
        <a class="w-nav-link main-link" href="news.html">news</a>
        <a class="w-nav-link main-link" href="publication.html">Publications</a>
        <a class="w-nav-link main-link" href="event.html">Events</a>
        <a class="w-nav-link main-link" href="contact.html">CONTACT Us</a>
      </nav>
  ...
  <section class="w-section section-hero title about publication">
    <div class="w-container container about-header">
      <h1 class="bottom-margin-small">This is Publication Title</h1>
      <h3 class="hero-sub-title">24th August 2015</h3>
    </div>
  </section>
  <section class="w-section section---white-holder">
    <div class="w-container container">
      <h2 class="selected-news-title"><?php echo $daftar_jurnalis->judul;?></h2>
      <p class="bottom-margin-medium paragraph-justified"><?php echo $daftar_jurnalis->deskripsi;?>. Curabitur blandit tempus porttitor. Nullam quis risus eget urna mollis ornare vel eu leo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus sagittis lacus vel augue laoreet rutrum faucibus dolor auctor.
        <br>
        <br>Maecenas sed diam eget risus varius blandit sit amet non magna. Etiam porta sem malesuada magna mollis euismod. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Nulla vitae elit libero, a pharetra augue.&nbsp;Nulla vitae elit libero, a pharetra augue. Aenean eu leo quam. Pellentesque ornare sem lacinia quam venenatis vestibulum. Vestibulum id ligula porta felis euismod semper. Nullam quis risus eget urna mollis ornare vel eu leo. Vestibulum id ligula porta felis euismod semper. Donec id elit non mi porta gravida at eget metus.
    	</br>
      ...
      <a class="publication-link" href="<?php echo urldecode($daftar_jurnalis->link);?>"><?php echo urldecode($daftar_jurnalis->link);?> </a>
       <a class="publication-link" href="<?php echo site_url('publik/index');?>">Back to home </a>
    </div>
  </section>
  <section class="w-section section publication">
    <div class="w-container container">
      <h2 class="bottom-margin-medium">Publication Updates</h2>
      <div class="w-row row">
        <div class="w-col w-col-4 col">
          <article class="third-block-holder-single">
            <article class="third-block-content-single bottom-margin-medium">
              <div class="date">24 Aug 2015</div>
              <h4 class="bottom-margin-small">This is publication title</h4>
        ...
        <div class="w-col w-col-4 col">
          <article class="third-block-holder-single">
            <article class="third-block-content-single bottom-margin-medium">
              ...
              <h4 class="bottom-margin-small">THIS IS PUBLICATION TITLE</h4>
              <a class="small-text" href="#">SELENGKAPNYA →</a>
            </article>
          </article>
        </div>
        <div class="w-col w-col-4 col">
